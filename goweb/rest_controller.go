...
type NestedRestReader interface {
	Read(parentId string, id string, c *Context)
}
...
type NestedRestManyReader interface {
	ReadMany(parentId string, c *Context)
}
...
type NestedRestUpdater interface {
	Update(parentId string, id string, c *Context)
}
...
type NestedRestManyUpdater interface {
	UpdateMany(parentId string, c *Context)
}
...
type NestedRestCreator interface {
	Create(parentId string, c *Context)
}
...
type NestedRestDeleter interface {
	Delete(parentId string, id string, c *Context)
}
...
type NestedRestManyDeleter interface {
	DeleteMany(parentId string, c *Context)
}
